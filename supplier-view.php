    ...
    function script() {
        ...
        this.registerEvents = function () {
            ...
            document.addEventListener('submit', function (e) {
                if (e.target.id === 'editSupplierForm') {
                    e.preventDefault();
                    vm.saveUpdatedData(e.target);
                }
            });
        },
        ...
        this.showEditDialog = function (id) {
            $.get('database/get-supplier.php', { id: id }, function (supplierDetails) {
                ...
                BootstrapDialog.confirm({
                    ...
                    message: `
                        <form id="editSupplierForm" class="appForm">
                            <div class="appFormInputContainer">
                                <label for="supplier_name">Supplier Name</label>
                                <input type="text" class="appFormInput" id="supplier_name" value="${supplierDetails.supplier_name}" />
                            </div>
                            <div class="appFormInputContainer">
                                <label for="supplier_location">Location</label>
                                <input type="text" class="appFormInput" id="supplier_location" value="${supplierDetails.supplier_location}" />
                            </div>
                            <div class="appFormInputContainer">
                                <label for="email">Email</label>
                                <input type="text" class="appFormInput" id="email" value="${supplierDetails.email}" />
                            </div>
                            <div class="appFormInputContainer">
                            ...
                            <input type="hidden" id="sid" value="${supplierDetails.id}" />
                            <input type="submit" value="submit" id="editSupplierSubmitBtn" class="hidden"/>
                        </form>
                    `,
                    callback: function (isUpdate) {
                        if (isUpdate) document.getElementById('editSupplierSubmitBtn').click();
                    }
                });
            }, 'json');
        },
